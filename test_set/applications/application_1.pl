...
functionReqs(funzione1, [], (0, 1, 400), []).
functionReqs(funzione2, [], (0, 1, 1200), []).
...
functionBehaviour(fCheckDCC, [_,U], [U], [U, U]).
functionBehaviour(fRules, [_, U], [U], [U, U]).
functionBehaviour(funzione1, [_, U], [U], [low]).
functionBehaviour(funzione2, [_, U], [U], [low]).
